...
class __TwigTemplate_a5b3094d25f076122802f32bbceacb35 extends Template
{
    private $source;
    private $macros = [];
    ...
    public function __construct(Environment $env)
    {
        ...
        $this->blocks = [
            're_captcha_row' => [$this, 'block_re_captcha_row'],
        ];
    }
    ...
    public function block_re_captcha_row($context, array $blocks = [])
    {
        $macros = $this->macros;
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f = $this->extensions["Symfony\\Bridge\\Twig\\Extension\\ProfilerExtension"];
        $__internal_6f47bbe9983af81f1e7450e9a3e3768f->enter($__internal_6f47bbe9983af81f1e7450e9a3e3768f_prof = new \Twig\Profiler\Profile($this->getTemplateName(), "block", "re_captcha_row"));
...
";
    ...
    {
        return new Source("{% block re_captcha_row %}
    <div id=\"{{ id }}\" data-toggle=\"recaptcha\" data-type=\"{{ type }}\">  
    </div>
{% endblock %}", "form/custom_types.html.twig", "C:\\xampp\\htdocs\\movies\\templates\\form\\custom_types.html.twig");
    }
}
