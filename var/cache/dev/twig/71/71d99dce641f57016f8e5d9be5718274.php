...
class __TwigTemplate_8ed5bb919ed1e9566f4c538bc62c19bc extends Template
{
    private $source;
    private $macros = [];
...
<form method=\"post\">
    ...
    {% if app.user %}
        <div class=\"mb-3\">
            Jesteś zalogowany na {{ app.user.username }}, <a href=\"{{ path('app_logout') }}\">Wylogowano</a>
        </div>
    {% endif %}
...
{% endblock %}
", "security/login.html.twig", "C:\\xampp\\htdocs\\movies\\templates\\security\\login.html.twig");
    }
}
