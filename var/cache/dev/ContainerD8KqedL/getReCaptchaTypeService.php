 ...
 */
class getReCaptchaTypeService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Form\ReCaptchaType' shared autowired service.
     *
     * @return \App\Form\ReCaptchaType
     */
    public static function do($container, $lazyLoad = true)
    {
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'form'.\DIRECTORY_SEPARATOR.'FormTypeInterface.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'form'.\DIRECTORY_SEPARATOR.'AbstractType.php';
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Form'.\DIRECTORY_SEPARATOR.'ReCaptchaType.php';
        ...
        return $container->privates['App\\Form\\ReCaptchaType'] = new \App\Form\ReCaptchaType(new \ReCaptcha\ReCaptcha($container->getEnv('GOOGLE_RECAPTCHA_SECRET_KEY'), new \ReCaptcha\RequestMethod\CurlPost()));
    }
}
