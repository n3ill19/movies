...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer3f611 && ($this->initializer3f611->__invoke($valueHolderdd340, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer3f611) || 1) && $this->valueHolderdd340 = $valueHolderdd340;

        if ($this->valueHolderdd340 === $returnValue = $this->valueHolderdd340->paginate($target, $page, $limit, $options)) {
            return $this;
        }
